			...
			<Section className="story-component-group story-prop-table">
				...
				<PropsTable
					propsData={[
						...
						['stackSmall', 'bool', 'false', '-', 'Changes flex-direction to `column` on small screens'],
						['stackMedium', 'bool', 'false', '-', 'Changes flex-direction to `column` on medium screens'],
						['stackLarge', 'bool', 'false', '-', 'Changes flex-direction to `column` on large screens'],
						['swapSmall', 'bool', 'false', '-', 'Changes flex-direction to reverse-row, or reverse-column if stacked on small screens'],
						['swapMedium', 'bool', 'false', '-', 'Changes flex-direction to reverse-row, or reverse-column if stacked on medium screens'],
						['swapLarge', 'bool', 'false', '-', 'Changes flex-direction to reverse-row, or reverse-column if stacked on large screens'],
